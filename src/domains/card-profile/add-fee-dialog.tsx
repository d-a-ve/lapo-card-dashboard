...
import { ACCOUNT_PAD, CURRENCY, FEE_FREQUENCY, FEE_IMPACT } from "@/constants";
...
export const addFeeSchema = z.object({
  ...
  feeFrequency: z.enum(["", ...feeFrequency]),
  feeImpact: z.enum(["", ...feeImpact]),
  accountPad: z.enum([
    ACCOUNT_PAD.NONE,
    ACCOUNT_PAD.PREFIX,
    ACCOUNT_PAD.SUFFIX,
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <RadioGroup
                        ...
                        checked={(value) => field.value === value}
                        renderRadio={(value) => (
